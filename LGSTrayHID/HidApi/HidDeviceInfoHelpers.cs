...
namespace LGSTrayHID.HidApi
{
    ...
    public static class HidDeviceInfoHelpers
    {
        public static string GetPath(this HidDeviceInfo deviceInfo)
        {
            unsafe
            {
        ...
        public static HidppMessageType GetHidppMessageType(this HidDeviceInfo deviceInfo)
        {
            unsafe
            {
